...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  {
    ...
    icon: 'sunrise',
    condition: { type: 'streak_days', days: 1 },
  },
  {
    id: 'day_3',
  ...
  },
  {
    id: 'checkin_7',
    title: 'Checking In',
    description: '7 check-ins completed',
    icon: 'check-circle',
    condition: { type: 'checkins_count', count: 7 },
  },
  {
    id: 'checkin_30',
    title: 'Consistent',
    ...
    icon: 'clipboard',
    condition: { type: 'checkins_count', count: 30 },
  },
  {
    id: 'journal_5',
    title: 'Reflector',
    ...
    icon: 'book-open',
    condition: { type: 'journal_entries', count: 5 },
  },
  {
    id: 'journal_25',
    title: 'Storyteller',
    description: '25 journal entries written',
    icon: 'feather',
    condition: { type: 'journal_entries', count: 25 },
  },
];
